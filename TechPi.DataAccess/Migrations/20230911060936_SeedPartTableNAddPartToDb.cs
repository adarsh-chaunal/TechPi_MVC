...
{
    /// <inheritdoc />
    public partial class SeedPartTableNAddPartToDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Parts",
                columns: new[] { "Id", "InStock", "PartCode", "PartName", "Price", "Price100", "Price50", "Product" },
                values: new object[] { 1L, true, "1234567", "Part 1", 100m, 7000m, 4000m, "Product 1" });
        }
